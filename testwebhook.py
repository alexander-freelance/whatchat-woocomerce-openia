...
WEBHOOK_URL = 'https://webhook.whatchat.co/llm-integration'  # Update this to your correct URL if hosted elsewhere

# Define the valid API key (ensure this matches your environment variable)
VALID_API_KEY = '0e86231913e6e034cc34e1b17d51dba4'
